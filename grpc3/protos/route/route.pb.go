...
var file_route_proto_rawDesc = []byte{
	...
	0x65, 0x4e, 0x6f, 0x74, 0x65, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x03, 0x5a, 0x01, 0x2e,
...
var file_route_proto_depIdxs = []int32{
	...
	1, // 5: route.Route.ListFeatures:input_type -> route.Rectangle
	0, // 6: route.Route.RecordRoute:input_type -> route.Point
	4, // 7: route.Route.RouteChat:input_type -> route.RouteNote
	2, // 8: route.Route.GetFeature:output_type -> route.Feature
	2, // 9: route.Route.ListFeatures:output_type -> route.Feature
